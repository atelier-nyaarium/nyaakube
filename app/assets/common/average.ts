 ...
 *
 * @param stats - The existing stats object. Must have 'value' and 'weight' properties.
 * @param value - The new value to be averaged. If it's an object, it must have 'value' and 'weight' properties.
 * @param maxWeight - The maximum weight that can be considered for the existing average.
 *
 ...
 *
 * @returns An object with the new average 'value' and 'weight'.
 *
 * @example
